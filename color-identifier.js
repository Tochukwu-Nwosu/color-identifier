...
// This function gets the stored theme or use darkMode as the default mode if none is found.
const getTheme = () => {
...
// This function changes the theme of the application between dark and light.
...
boxOne.addEventListener("click", () =>
  resultVerifier(boxValueArray[0], boxOne),
);
boxTwo.addEventListener("click", () =>
  resultVerifier(boxValueArray[1], boxTwo),
);
boxThree.addEventListener("click", () =>
  resultVerifier(boxValueArray[2], boxThree),
);
boxFour.addEventListener("click", () =>
  resultVerifier(boxValueArray[3], boxFour),
);
boxFive.addEventListener("click", () =>
  resultVerifier(boxValueArray[4], boxFive),
);
boxSix.addEventListener("click", () =>
  resultVerifier(boxValueArray[5], boxSix),
);
modeButton.addEventListener("click", () => handleThemeChange());
